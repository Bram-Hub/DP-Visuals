...
class TestParsing(unittest.TestCase):
    ...
    def test_disjunction(self):
        ...
        self.assertEqual(statement.__str__(), "v(A, B)")
        ...
        self.assertEqual(statement.__str__(), "v(A, v(B, C))")
        ...
        self.assertEqual(statement.value2().type, "lit")
        self.assertEqual(statement.__str__(), "v(v(A, B), C)")
        ...
        self.assertEqual(statement.value1().type, "v")
        self.assertEqual(statement.value2().type, "v")
        self.assertEqual(statement.__str__(), "v(v(A, B), v(C, D))")

        statement = parse("Av(Bv(CvD))")
        self.assertIsNotNone(statement)
        self.assertEqual(statement.__str__(), "v(A, v(B, v(C, D)))")
